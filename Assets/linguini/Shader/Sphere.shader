Shader "linguini/RayMarching/Cubes"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float3 repeat(float3 pos){
                return abs(fmod(pos, _Size * 2)) - _Size;
            }
            ...
            float sceneDist(float3 pos){
                pos.xy = rotate(pos.xy, _Time.y * 0.5);
                pos.yz = rotate(pos.yz, _Time.y * 0.5);
                pos.zx = rotate(pos.zx, _Time.y * 0.5);
                return cubeDist(repeat(pos));
            }
